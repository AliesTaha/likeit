...
import { DefaultProps, MantineNumberSize, MantineShadow, ClassNames, MantineStyleSystemSize } from '@mantine/styles';
import { MantineTransition } from '../Transition';
import useStyles, { DrawerPosition } from './Drawer.styles';
export declare type DrawerStylesNames = Exclude<ClassNames<typeof useStyles>, 'withOverlay'>;
