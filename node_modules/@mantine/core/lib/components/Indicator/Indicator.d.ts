...
import { ClassNames, DefaultProps, MantineColor, MantineNumberSize } from '@mantine/styles';
import { IndicatorPosition } from './Indicator.types';
import useStyles from './Indicator.styles';
export declare type IndicatorStylesNames = ClassNames<typeof useStyles>;
export interface IndicatorProps extends DefaultProps<IndicatorStylesNames>, React.ComponentPropsWithoutRef<'div'> {
